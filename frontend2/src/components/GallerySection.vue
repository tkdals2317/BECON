      ...
      <div class="mixitup-gallery">
        ...
        <div class="filter-list row">
          ...
          <div class="gallery-item mix all web-design col-lg-4 col-md-6 col-sm-12">
            <div class="inner-box">
              <figure class="image"><img src="@/common/images/gallery/1.jpg" alt=""></figure>
              ...
              <div class="cap-box">
                <div class="cap-inner">
                  ...
                  <div class="title">
                    <h5><router-link to="/portfolio-single">Fimlor Experience</router-link></h5>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="gallery-item mix all photography web-design col-lg-4 col-md-6 col-sm-12">
            <div class="inner-box">
              <figure class="image"><img src="@/common/images/gallery/2.jpg" alt=""></figure>
          ...
          <div class="gallery-item mix all branding web-design col-lg-4 col-md-6 col-sm-12">
            <div class="inner-box">
              <figure class="image"><img src="@/common/images/gallery/3.jpg" alt=""></figure>
          ...
          <div class="gallery-item mix all branding illustration col-lg-4 col-md-6 col-sm-12">
            <div class="inner-box">
              <figure class="image"><img src="@/common/images/gallery/4.jpg" alt=""></figure>
          ...
          <div
            ...
            <div class="inner-box">
              <figure class="image"><img src="@/common/images/gallery/5.jpg" alt=""></figure>
          ...
          <div class="gallery-item mix all illustration photography col-lg-4 col-md-6 col-sm-12">
            <div class="inner-box">
              <figure class="image"><img src="@/common/images/gallery/6.jpg" alt=""></figure>

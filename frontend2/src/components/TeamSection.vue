    ...
    <div class="carousel-box">
      <div class="team-carousel">
        ...
        <div class="team-block">
          <div class="inner-box">
            <div class="image-box">
              <a href="/about"><img src="@/common/images/resource/team-1.jpg" alt=""></a>
        ...
        <div class="team-block">
          <div class="inner-box">
            <div class="image-box">
              <a href="/about"><img src="@/common/images/resource/team-2.jpg" alt=""></a>
              <ul class="social-links clearfix">
                <li><a href="#"><span class="fab fa-facebook-square"></span></a></li>
                <li><a href="#"><span class="fab fa-twitter"></span></a></li>
                <li><a href="#"><span class="fab fa-instagram"></span></a></li>
        ...
        <div class="team-block">
          <div class="inner-box">
            <div class="image-box">
              <a href="/about"><img src="@/common/images/resource/team-3.jpg" alt=""></a>
              <ul class="social-links clearfix">
                <li><a href="#"><span class="fab fa-facebook-square"></span></a></li>
                <li><a href="#"><span class="fab fa-twitter"></span></a></li>
                <li><a href="#"><span class="fab fa-instagram"></span></a></li>
        ...
        <div class="team-block">
          <div class="inner-box">
            <div class="image-box">
              <a href="/about"><img src="@/common/images/resource/team-4.jpg" alt=""></a>
              <ul class="social-links clearfix">
                <li><a href="#"><span class="fab fa-facebook-square"></span></a></li>
                <li><a href="#"><span class="fab fa-twitter"></span></a></li>
                <li><a href="#"><span class="fab fa-instagram"></span></a></li>
        ...
        <div class="team-block">
          <div class="inner-box">
            <div class="image-box">
              <a href="/about"><img src="@/common/images/resource/team-5.jpg" alt=""></a>
              <ul class="social-links clearfix">
                <li><a href="#"><span class="fab fa-facebook-square"></span></a></li>
                <li><a href="#"><span class="fab fa-twitter"></span></a></li>
                <li><a href="#"><span class="fab fa-instagram"></span></a></li>

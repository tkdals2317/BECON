    ...
    <section class="banner-section banner-one">
      ...
      <div class="banner-carousel">
        ...
        <div class="slide-item">
          <div class="image-layer" style="background-image: url(/common/images/main-slider/1.jpg);"></div>
            ...
            <div class="content-box">
              <div class="content">
                <div class="inner">
                  ...
                  <div class="link-box">
                    <router-link class="theme-btn btn-style-one" to="/about">
                      <i class="btn-curve"></i>
        ...
        <!-- Slide Item -->
        <div class="slide-item">
          <div class="image-layer" style="background-image: url(/common/images/main-slider/2.jpg);"></div>
          <div class="left-top-line"></div>
          <div class="right-bottom-curve"></div>
          <div class="right-top-curve"></div>
          <div class="auto-container">

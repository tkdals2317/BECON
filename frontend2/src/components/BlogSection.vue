    ...
    <div class="auto-container">
      ...
      <div class="row clearfix">
        ...
        <div class="news-block col-lg-4 col-md-6 col-sm-12 wow fadeInUp" data-wow-delay="0ms"
          ...
          <div class="inner-box">
            <div class="image-box">
              <a href="#"><img src="@/common/images/resource/news-1.jpg" alt=""></a>
            </div>
            <div class="lower-box">
              <div class="post-meta">
                <ul class="clearfix">
              ...
              <h5><router-link to="/blog-single">basic rules of running web agency business</router-link></h5>
        ...
        <div class="news-block col-lg-4 col-md-6 col-sm-12 wow fadeInUp" data-wow-delay="300ms"
          ...
          <div class="inner-box">
            <div class="image-box">
              <a href="#"><img src="@/common/images/resource/news-2.jpg" alt=""></a>
            </div>
            <div class="lower-box">
              <div class="post-meta">
                <ul class="clearfix">
              ...
              <h5><router-link to="/blog-single">Delivering the best digital marketing</router-link></h5>
              <div class="text">Lorem ipsum is simply free text used by copytyping refreshing.</div>
              <div class="link-box"><a class="theme-btn" href="#"><span
                class="flaticon-next-1"></span></a></div>
            </div>
        ...
        <div class="news-block col-lg-4 col-md-6 col-sm-12 wow fadeInUp" data-wow-delay="600ms"
          ...
          <div class="inner-box">
            <div class="image-box">
              <a href="#"><img src="@/common/images/resource/news-3.jpg" alt=""></a>
            </div>
            <div class="lower-box">
              <div class="post-meta">
                <ul class="clearfix">
              ...
              <h5><router-link to="/blog-single">Introducing the latest linoor features</router-link></h5>
              <div class="text">Lorem ipsum is simply free text used by copytyping refreshing.</div>
              <div class="link-box"><a class="theme-btn" href="#"><span
                class="flaticon-next-1"></span></a></div>
            </div>

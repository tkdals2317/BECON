    ...
    <div class="hide-on-small">
      ...
      <div class="tool-wrapper">
        ...
        <div class="button-wrapper">
          <span v-if="!isLogin">
            <el-button class="el-icon-circle-plus-outline" @click="clickRegister"> 회원가입</el-button>
            <el-button type="primary" class="el-icon-key" @click="clickLogin"> 로그인</el-button>
          </span>
          <span v-if="isLogin">
            <el-button type="primary" @click="clickProfile">내프로필</el-button>
          <el-button type="primary" class="el-icon-switch-button" @click="clickLogout">로그아웃</el-button>
          </span>
        </div>
      </div>
      ...
      <div class="mobile-sidebar-wrapper" v-if="!state.isCollapse">
        <div class="mobile-sidebar">
          <div class="mobile-sidebar-tool-wrapper">
            ...
            <span v-if="isLogin">
              <el-button type="primary" class="mobile-sidebar-btn login-btn" @click="clickProfile">내프로필</el-button>
              <el-button class="mobile-sidebar-btn register-btn el-icon-switch-button" @click="clickLogout">로그아웃</el-button>
            </span>
          </div>
          <el-menu
...
export default {
  ...
  setup(props, { emit }) {
    ...
    return { state, menuSelect, clickLogo, clickLogin, clickRegister, clickLogout, clickProfile, changeCollapse }
  }
}
</script>
<style>

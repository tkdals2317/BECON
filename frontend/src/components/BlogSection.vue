      ...
      <div class="row clearfix">
            ...
            <div class="lower-box">
              ...
              <h5>
                <router-link to="/blog-single"
                  >basic rules of running web agency business</router-link
                >
              </h5>
              <div class="text">
        ...
        >
          <div class="inner-box">
            <div class="image-box">
              <a href="#"
                ><img src="@/common/images/resource/news-2.jpg" alt=""
              /></a>
            </div>
            <div class="lower-box">
              <div class="post-meta">
              ...
              <h5>
                <router-link to="/blog-single"
                  >Delivering the best digital marketing</router-link
                >
              </h5>
              <div class="text">
                Lorem ipsum is simply free text used by copytyping refreshing.
        ...
        >
          <div class="inner-box">
            <div class="image-box">
              <a href="#"
                ><img src="@/common/images/resource/news-3.jpg" alt=""
              /></a>
            </div>
            <div class="lower-box">
              <div class="post-meta">
              ...
              <h5>
                <router-link to="/blog-single"
                  >Introducing the latest linoor features</router-link
                >
              </h5>
              <div class="text">
                Lorem ipsum is simply free text used by copytyping refreshing.

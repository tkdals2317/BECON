      ...
      <div class="row clearfix">
        ...
        <div class="left-col col-lg-6 col-md-12 col-sm-12">
          <div class="inner">
            <div class="sec-title">
              <h2>
                We do more then ever <br />platforms <span class="dot">.</span>
              </h2>
            </div>
            <div class="featured-block clearfix">
              <div class="image">
                <img
                  src="@/common/images/resource/featured-image-4.jpg"
                  alt=""
                />
              </div>
              <div class="text">
...
export default {
  name: "WedoSection",
  mounted() {
    var el = document.querySelector(".accordion-container-one");
    new Accordion(el);
  },
};
</script>

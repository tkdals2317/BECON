      ...
      <div class="row clearfix">
          ...
          <div class="inner-box">
            ...
            <h6>
              <router-link to="/web-development"
                >Website <br />Development</router-link
              >
            </h6>
          </div>
        </div>
          ...
          <div class="inner-box">
            ...
            <h6>
              <router-link to="/graphic-designing"
                >graphic <br />designing</router-link
              >
            </h6>
          </div>
        </div>
          ...
          <div class="inner-box">
            ...
            <h6>
              <router-link to="/digital-marketing"
                >digital <br />marketing</router-link
              >
            </h6>
          </div>
        </div>
        ...
        >
          <div class="inner-box">
            ...
            <h6>
              <router-link to="/seo">seo & content <br />writing</router-link>
            </h6>
          </div>
        </div>
        <!--Service Block-->
          ...
          <div class="inner-box">
            ...
            <h6>
              <router-link to="/app-development"
                >App <br />Development</router-link
              >
            </h6>
          </div>
        </div>
          ...
          <div class="inner-box">
            ...
            <h6>
              <router-link to="/ui-designing"
                >Ui/UX <br />designing</router-link
              >
            </h6>
          </div>
        </div>
